...
//	int map_diffuse = int(DataIn.texcoord.z);
//	sampler2D textureID_temp = textureID0;
//	if (map_diffuse < 0.5)
//		textureID_temp = textureID0;
//	else if (map_diffuse < 1.5)
//		textureID_temp = textureID1;
//	else if (map_diffuse < 2.5)
//		textureID_temp = textureID2;
//	else if (map_diffuse < 3.5)
//		textureID_temp = textureID3;
//	else if (map_diffuse < 4.5)
//		textureID_temp = textureID4;
//	else
//		textureID_temp = textureID0;
